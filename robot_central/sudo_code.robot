...
TC_01
    ...
    Wait Until Element Is Visible    //*[starts-with(@id,'wrap-close-button')]//span[text()='×']
    Click Element    //*[starts-with(@id,'wrap-close-button')]//span[text()='×']
    ...
    Wait Until Element Is Visible    //a[@href='/dior']
...
t    
    ...
    # step 5.2.6.1 Verify that "Address" input is empty
    # step 5.2.6.2 Input "Address" = 10260
    # step 5.2.6.3 Verify that "Address" input = 10260
