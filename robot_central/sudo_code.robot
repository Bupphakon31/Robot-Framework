...
TC_01
    ...
    ...       gc    
    ...    options=binary_location="/Users/n658192/Documents/chrome/Google Chrome for Testing.app/Contents/MacOS/Google Chrome for Testing";add_experimental_option("detach", True);add_argument("--disable-notifications");add_experimental_option("prefs",${prefs})     
    ...    executable_path=/Users/n658192/Documents/chrome/chromedriver
    ...
    # step 2.3 Choose product "Dior Homme Deodorant stick"
    ...
    # step 2.7 Verify that product "Dior Homme Deodorant stick" same product list page
    ...
    Wait Until Element Is Visible    //section[@id='freeGiftsBtn']/span[@class='spc-feature-list-item__gift-count'][text()='1']
    ...
    # step 5.0.1.1 Verify that product "Dior Homme Deodorant stick" same product list page

    # step 5.0.1.1.0     scroll to element
    Scroll Into View    //section[@class='spc-product-card' and .//*[text()='Dior Homme Deodorant stick']]

    # step 5.0.1.1.1 Verify that band
    Wait Until Element Is Visible    //section[@class='spc-product-card' and .//*[text()='Dior Homme Deodorant stick']]//*[text()='DIOR']

    # step 5.0.1.1.2 Verify that name
    Page Should Contain Element    //section[@class='spc-product-card' and .//*[text()='Dior Homme Deodorant stick']]


    # step 5.0.1.1.3 Verify that price
    Page Should Contain Element    //section[@class='spc-product-card' and .//*[text()='Dior Homme Deodorant stick']]//*[normalize-space(.)='฿1,305']

    # step 5.0.1.1.4 Verify that qty
    Page Should Contain Element    //section[@class='spc-product-card' and .//*[text()='Dior Homme Deodorant stick']]//*[normalize-space(text())='Quantity: 1']
    ...
    Scroll Into View    //section[@class='spc-product-card' and .//*[text()="Miss Dior Rose N'Roses${SPACE * 2}Eau de Toilette Roller-Pearl - Roll-On Fragrance 20 mL"]]

    # step 5.0.1.2.1 Verify that band
    Wait Until Element Is Visible    //section[@class='spc-product-card' and .//*[text()="Miss Dior Rose N'Roses${SPACE * 2}Eau de Toilette Roller-Pearl - Roll-On Fragrance 20 mL"]]//*[text()='DIOR']
    
    # step 5.0.1.2.2 Verify that name
    Page Should Contain Element    //section[@class='spc-product-card' and .//*[text()="Miss Dior Rose N'Roses${SPACE * 2}Eau de Toilette Roller-Pearl - Roll-On Fragrance 20 mL"]]
    
    # step 5.0.1.2.3 Verify that price
    Page Should Contain Element    //section[@class='spc-product-card' and .//*[text()="Miss Dior Rose N'Roses${SPACE * 2}Eau de Toilette Roller-Pearl - Roll-On Fragrance 20 mL"]]//*[normalize-space(.)='฿1,935']
    
    # step 5.0.1.2.4 Verify that qty
    Page Should Contain Element    //section[@class='spc-product-card' and .//*[text()="Miss Dior Rose N'Roses${SPACE * 2}Eau de Toilette Roller-Pearl - Roll-On Fragrance 20 mL"]]//*[normalize-space(text())='Quantity: 1']
