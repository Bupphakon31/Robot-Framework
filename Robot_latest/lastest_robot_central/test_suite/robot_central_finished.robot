...
TC_01
    ...
    Mouse Out    //*[@data-product-sku="CDS6340728"]
    ...
    Wait Until Element Is Visible    //section[@id='freeGiftsBtn']/span[@class='spc-feature-list-item__gift-count'][text()='3']
    ...
    Wait Until Element Is Visible    //*[@class='d-flex' and ./*[normalize-space(.)='Sub Total (2 Items)']]//*[normalize-space(.)='฿6,930']
    ...
    Wait Until Element Is Visible    //*[@class='d-flex' and ./*[normalize-space(.)='Order Total incl. VAT']]//*[normalize-space(.)='฿6,930']
