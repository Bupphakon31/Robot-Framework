...
&{product_02}    name=J'Adore Deodorant 100 mL    price=${1900}    qty=1    #TODO: 20240724 -  2 whitespace
${discount}        ${0}
...
Scroll Into View Sub Total
    [Arguments]    ${locator} 
    ${temp_id}    Get Element Attribute    ${locator}    id

    Assign Id To Element    ${locator}    id=id_for_scroll

    Execute Javascript    document.querySelector('#id_for_scroll').scrollIntoView({ behavior: "smooth", block: "center", inline: "center" })

    Assign Id To Element    //*[@id='id_for_scroll']    ${temp_id}


Input Text By One Character
    [Arguments]    ${locator}    ${text}
    ${text_list}    Convert To List    ${text}
...
TC_01
    ...
    Input Text By One Character    //input[@data-testid='txt-searchProductList-searchQuery']    dior
    ...
    Scroll Into View         //*[@class='flip-card-front']//a[text()="J'Adore Deodorant 100 mL"]    #TODO: 20240724 -  2 whitespace

    # step 2.4.1.1 Verify that Image is show
    Page Should Contain Element    //*[@data-product-sku="CDS94521542"]//img

    # step 2.4.1.2 Verify that Price is show

    ${price_with_format}    Format String    ฿{:,}    ${product_02}[price]
    # Element Should Be Visible    //*[@data-product-sku='CDS94521542']//h4[@class='finalPrice'][text()='฿1,935']
    Element Should Be Visible    //*[@data-product-sku='CDS94521542']//h4[@class='finalPrice'][text()='${price_with_format}']

    # step 2.4.1.3 Verify that Brand is show
    Element Should Be Visible    //*[@data-product-sku='CDS94521542']//a[@class='sliderTitle'][text()= 'DIOR']

    # step 2.4.1.3 Verify that Name is show
    Element Should Be Visible    //*[@data-product-sku='CDS94521542']//a[text()="J'Adore Deodorant 100 mL"]    #TODO: 20240724 -  2 whitespace

    Mouse Out    //*[@data-product-sku="CDS94521542"]

    # step 2.4.1.3 Verify that Home Delivery is show
    Element Should Be Visible    //*[@data-product-sku='CDS94521542']//span[contains(@class,'home-delivery-badge')][text()='Home Delivery']

    # step 2.4.2 Mouse Over on product 
    Mouse Over    //*[@data-product-sku="CDS94521542"]

    # step 2.4.2.1 Verify that "Wish list" button is show
    Wait Until Element Is Visible    //*[@data-product-sku="CDS94521542"]//button/label[text()='WISHLIST']

    # step 2.4.2.2 Verify that "Add to bag" button is show
    Element Should Be Visible    //*[@data-product-sku="CDS94521542"]//button/span[text()='ADD TO BAG']

    # step 2.4.3 Click "Add to bag" button
    Click Button    //*[@data-product-sku="CDS94521542"]//button[./span[text()='ADD TO BAG'] ]
    ...
    Scroll Into View    //section[@id='CDS94521542']

    # step 2.8.1 Verify that brand label is show
    Element Text Should Be    //section[@id='CDS94521542']//a[@class='spc-product-card__card-brand-name']    DIOR

    # step 2.8.2 Verify that name label is show
    Page Should Contain Element    //section[@id='CDS94521542']//a[starts-with(@class,'spc-product-card__card-nam')][text()="J'Adore Deodorant 100 mL"]    #TODO: 20240724 -  2 whitespace

    # step 2.8.3 Verify that price label is show
    ${price_with_format}    Format String    ฿{:,}    ${product_02}[price]
    # Page Should Contain Element    //section[@id='CDS94521542']//*[@class='spc-product-card__card-price-wrap']/*[starts-with(@class,'spc-product-card__card-price')][normalize-space(.)='฿1,935']
    Page Should Contain Element    //section[@id='CDS94521542']//*[@class='spc-product-card__card-price-wrap']/*[starts-with(@class,'spc-product-card__card-price')][normalize-space(.)='${price_with_format}']

    # step 2.8.4 Verify that qty label is show
    Element Text Should Be    //section[@id='CDS94521542']//span[starts-with(@class,'spc-product-card__card-quantity')]    1
    ...
    Scroll Into View      //*[@id='spcCouponsPricing']//p[@class='spc-feature-list-item__redeem-title'][normalize-space(.)='You can earn 158 Points']             #TODO: 20240724 - Dynamic data

    # step 2.13 Verify that "You can earn 130 Points"
    Wait Until Element Is Visible    //*[@id='spcCouponsPricing']//p[@class='spc-feature-list-item__redeem-title'][normalize-space(.)='You can earn 158 Points']    #TODO: 20240724 - Dynamic data
    ...
    Page Should Contain Element    //section[@class='spc-product-card' and .//*[text()='La Mousse OFF/ON Foaming Cleanser 150 mL']]//*[normalize-space(.)='฿2,050']
    ...
    Scroll Into View    //section[@class='spc-product-card' and .//*[text()="J'Adore Deodorant 100 mL"]]

    # step 5.0.1.2.1 Verify that band
    Wait Until Element Is Visible    //section[@class='spc-product-card' and .//*[text()="J'Adore Deodorant 100 mL"]]//*[text()='DIOR']
    
    # step 5.0.1.2.2 Verify that name
    Page Should Contain Element    //section[@class='spc-product-card' and .//*[text()="J'Adore Deodorant 100 mL"]]
    
    # step 5.0.1.2.3 Verify that price
    Page Should Contain Element    //section[@class='spc-product-card' and .//*[text()="J'Adore Deodorant 100 mL"]]//*[normalize-space(.)='฿1,900']
    
    # step 5.0.1.2.4 Verify that qty
    Page Should Contain Element    //section[@class='spc-product-card' and .//*[text()="J'Adore Deodorant 100 mL"]]//*[normalize-space(text())='Quantity: 1']
    ...
    # step 5.2.1.2 Input "First Name" = Bupphakon
    Input Text    //input[@id='firstNameTxtbx']      Bupphakon

    # step 5.2.1.3 Verify that "First Name" input = Bupphakon
    Textfield Value Should Be     //input[@id='firstNameTxtbx']   Bupphakon
    ...
    # step 5.2.2.2 Input "Last Name" = Silarat
    Input Text    //input[@id='lastNameTxtbx']    Silarat

    # step 5.2.2.3 Verify that "Last Name" input = Silarat
    Textfield Value Should Be     //input[@id='lastNameTxtbx']    Silarat
    ...
    # step 5.2.3.2 Input "Phone Number" = 0912345678
    Input Text    //input[@id='phoneNoTxtbx']    0912345678

    # step 5.2.3.3 Verify that "Phone Number" input = 0912345678
    ...
    Wait Until Element Is Visible    //a[@id='submitAddAddress']//span[text()='Use This Address']
    Click Element    //a[@id='submitAddAddress']//span[text()='Use This Address']
    Wait Until Page Contains Element   //*[@id='page-loader'][contains(@class, 'd-none')]
    Sleep    2    
    
    # step 5.2.11.1 Verify that "Office" lable is show
    Wait Until Element Is Visible    //*[@id='addressoutputshipping']/section[.//*[text()='Office']]

    # step 5.2.11.2 Verify that "Office" Radio button is checked
    Page Should Contain Radio Button    //*[@id='addressoutputshipping']/section[.//*[text()='Office']]//input[@data-testid='rdo-saveShippingAddress-1'][@value='1']

    # step 5.3 Click "Use This Address" button 
    Sleep    2
    Click Element           //a[@data-testid='btn-saveAddress-useThisAddress']//span[text()='Use This Address']
    Wait Until Page Contains Element   //*[@id='page-loader'][contains(@class, 'd-none')]
    Sleep    1
    # step 5.3.1 Verify that "First Name", "Last Name" and "Phone Number"
    Wait Until Element Is Visible    //section[@data-testid='btn-viewShippingAddress-list']//span[@class='firstname'][text()='Bupphakon']
    Page Should Contain Element      //section[@data-testid='btn-viewShippingAddress-list']//span[@class='lastname'][text()='Silarat']
    Page Should Contain Element      //section[@data-testid='btn-viewShippingAddress-list']//span[@class='telephone'][text()='0912345678']
    
    # step 5.3.2 Verify that "Address"
    Page Should Contain Element    //section[@data-testid='btn-viewShippingAddress-list']//*[contains(@class,'address')][text()='11/35 Lotus, Bangkok, Phra Khanong, Bang Chak, 10260']

    # step 5.4 Choose Home Delivery
    Click Element    //*[@data-testid='rdo-saveCheckout-selectDeliveryMethodstandard']

    # step 5.4.1 Verify that "Home Delivery" is checked
    Wait Until Element Is Visible    //*[@data-testid='rdo-saveCheckout-selectDeliveryMethodstandard'][@checked]

        
    # step 5.5 Payment Method
    
    # step 5.5.0 Scroll to Payment Methods section
    Scroll Into View        //*[@id='spcPaymentMethodsCreditCard']//h3[text()='Payment Methods']
    Wait Until Element Is Visible    //*[@id='spcPaymentMethodsCreditCard']//h3[text()='Payment Methods']

    # step 5.5.1 Choose "Credit/Debit Card" 
    Click Element    //input[@data-testid='rdo-saveCheckout-cardPayment']

    # step 5.5.1.1 Verify that "Credit/Debit Card" is checked
    Wait Until Element Is Visible    //label[@for='payment_service_fullpayment']
    ${is_checked}    Execute Javascript    return document.querySelector("[data-testid='rdo-saveCheckout-cardPayment']").checked
    Should Be True    ${is_checked}

    # step 5.5.2 Input "Name on Card"
    # step 5.5.2.1 Verify that "Name on Card" input is empty
    Textfield Value Should Be    //*[@id='spcNewCardWrap']//*[@id='cardName']    ${EMPTY}

    # step 5.5.2.2 Input "Name on Card" = B.pen
    Input Text    //*[@id='spcNewCardWrap']//*[@id='cardName']       B.Sila

    # step 5.5.2.3 Verify that "Name on Card" input = B.pen
    Textfield Value Should Be    //*[@id='spcNewCardWrap']//*[@id='cardName']    B.Sila

    # step 5.5.3 Input "Card Number"
    # step 5.5.3.1 Verify that "Card Number" input is empty
    Textfield Value Should Be    //*[@id='spcNewCardWrap']//*[@id='cardNumber']    ${EMPTY}

    # step 5.5.3.2 Input "Card Number" = 4442594103424800
    # Input Text    //*[@id='spcNewCardWrap']//*[@id='cardNumber']    4442594103424800
    Input Text By One Character    //*[@id='spcNewCardWrap']//*[@id='cardNumber']    4442594103424800

    # step 5.5.3.3 Verify that "Card Number" input = 4442 5941 0342 4800
    Textfield Value Should Be    //*[@id='spcNewCardWrap']//*[@id='cardNumber']    4442 5941 0342 4800

    # step 5.5.3.4 Verify that "Card type" image = VISA
    Wait Until Element Is Visible    //*[@id='spcNewCardWrap']//img[@alt='visa']

    # step 5.5.4 Input "Expiry Date"
    

    # step 5.5.4.1 Verify that "Card Number" input is empty
    Textfield Value Should Be    //*[@id='spcNewCardWrap']//input[@id='expiryDate']    ${EMPTY}
    
    # step 5.5.4.2 Input "Card Number" = 1125
    Input Text By One Character    //*[@id='spcNewCardWrap']//input[@id='expiryDate']    1125

    # step 5.5.4.3 Verify that "Card Number" input = 11 / 25
    Textfield Value Should Be    //*[@id='spcNewCardWrap']//input[@id='expiryDate']    11 / 25

    # step 5.5.5 Input CVV
    # step 5.5.5.1 Verify that "CVV" input is empty
    Textfield Value Should Be    //*[@id='spcNewCardWrap']//input[@id='cvvNumber']    ${EMPTY}
    
    # step 5.5.5.2 Input "CVV" = 759
    Input Text    //*[@id='spcNewCardWrap']//input[@id='cvvNumber']    759

    # step 5.5.5.3 Verify that "CVV" input = 759
    Textfield Value Should Be    //*[@id='spcNewCardWrap']//input[@id='cvvNumber']    759

    # step 5.6 Verify that "Price summary" same "Product Pricing" 

    # step 5.6.0 Scroll to "Sub Total"
    Scroll Into View Sub Total    //*[@id='spcCheckoutPricingSummary']//*[starts-with(text(),'Sub Total')]

    # step 5.6.1 Verify that "Sub Total (2 Items)"
    # step 5.6.1.1 Verify that "Sub Total (2 Items)" label is show
    # step 5.6.1.2 Verify that "Sub Total (2 Items)" value = ฿3,420
    Wait Until Element Is Visible    //*[@class='d-flex' and ./*[normalize-space(.)='Sub Total (2 Items)']]//*[normalize-space(.)='฿3,950']

    # step 5.6.2 Verify that "Discount"
    # step 5.6.2.1 Verify that "Discount" label is show
    # step 5.6.2.2 Verify that "Discount" value = ฿0
    Wait Until Element Is Visible    //*[@class='d-flex' and ./*[normalize-space(.)='Discount']]//*[normalize-space(.)='฿0']
    ...
    Wait Until Element Is Visible    //*[@class='d-flex' and ./*[normalize-space(.)='Delivery Fee']]//*[normalize-space(text())='FREE']
    ...
    Wait Until Element Is Visible    //*[@class='d-flex' and ./*[normalize-space(.)='Order Total incl. VAT']]//*[normalize-space(.)='฿3,950']

    # step 5.7 Verify that "Place Order" button is show

    Page Should Contain Element    //*[@id='spcPlaceOrderBtn']
